...
/* Request numbers */
#define REQ_DIRWALKER	(VFS_BASE + 0)
...
#define REQ_INODEWALKER (VFS_BASE + 35)
#define REQ_ZONEMAPWALKER (VFS_BASE + 36)
#define REQ_INODEDAMAGE (VFS_BASE + 37)
#define REQ_INODEFIXER (VFS_BASE + 38)
